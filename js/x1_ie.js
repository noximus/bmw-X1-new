...
// Transition //
	...
	$('#container0').css("top", ($(".container").height() + 5) + 'px');
	$('#container0').css("left",($(".container").width() + 5) + 'px');
	
	$('#container1').css("top", '0px');
	$('#container1').css("left", '0px');
	
	$('#container2').css("top", ($(".container").height() + 5) + 'px');
	$('#container2').css("left", '0px');
	
	$('#container3').css("top", (($(".container").height() * 2) + 5) + 'px');
	$('#container3').css("left", '0px');
	
	$('#container4').css("top", (($(".container").height() * 2) + 5) + 'px');
	$('#container4').css("left",($(".container").width() + 5) + 'px');
	
	$('#container5').css("top", (($(".container").height() * 2) + 5) + 'px');
	$('#container5').css("left",(($(".container").width() * 2) + 5) + 'px');
	
	$('#container6').css("top", ($(".container").height() + 5) + 'px');
	$('#container6').css("left",(($(".container").width() * 3) + 5) + 'px');
	
	$('#container7').css("top", ($(".container").height() + 5) + 'px');
	$('#container7').css("left",(($(".container").width() * 2) + 5) + 'px');
	
	$('#container8').css("top", '0px');
	$('#container8').css("left",(($(".container").width()* 2) + 5) + 'px');
	
	$('#container9').css("top", '0px');
	$('#container9').css("left",($(".container").width() + 5) + 'px');
	...
	function flipTransition(fromContainerIndex, fromSlideIndex, toContainerIndex, toSlideIndex){
			...
			var scaleArray = [1, .5, .5, 1, .5, 1, 1, .5, 1, .5];
			var rotationArray = [0, 0, 0, 45, 0, -45, 45, 0, -45, 0];
			
			$('#page').animate({
				left: '-' + positionX,
				top: '-' + positionY
				}, 1500, 'linear', function(){
					$('#my'+ fromSlideIndex).hide();
				});
...
//					});
	...
	$("#text16 img").click(function(){
		//clearInterval(myInterval);
		rotateTransition(8,16,9,17);
		//myInterval = setInterval(function(){rotateTransition(currentContainerIndex,currentSlideIndex,nextContainerIndex,nextSlideIndex)}, 5000);
		});
	$("#text17 img").click(function(){
		//clearInterval(myInterval);
		rotateTransition(9,17,9,18);
		//myInterval = setInterval(function(){rotateTransition(currentContainerIndex,currentSlideIndex,nextContainerIndex,nextSlideIndex)}, 5000);
		});
	$("#text18 img").click(function(){
		//clearInterval(myInterval);
		rotateTransition(9,18,0,0);
		//myInterval = setInterval(function(){rotateTransition(currentContainerIndex,currentSlideIndex,nextContainerIndex,nextSlideIndex)}, 5000);
		});
	...
	$("#link17").click(function(){
		//clearInterval(myInterval);
		rotateTransition(currentContainerIndex,currentSlideIndex,9,17);
	    //myInterval = setInterval(function(){rotateTransition(currentContainerIndex,currentSlideIndex,nextContainerIndex,nextSlideIndex)}, 5000);
	});
	$("#link18").click(function(){
		//clearInterval(myInterval);
		rotateTransition(currentContainerIndex,currentSlideIndex,9,18);
		//myInterval = setInterval(function(){rotateTransition(currentContainerIndex,currentSlideIndex,nextContainerIndex,nextSlideIndex)}, 5000);
		});
